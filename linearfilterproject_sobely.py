...
for imagepath in imagepaths:
    ...
    filtered_img = filter_image(gray_img)
...
cv2.imwrite('OriginalGrayFiltered_sobely.png', (255.0*combined_image).astype(np.uint8))
...
plt.show()
plt.savefig('trainingvalidationlossgy.png')
...
with imageio.get_writer('weightmoviegy.gif', mode='I') as writer:
...
cv2.imwrite('PredictedFiltered_sobely.png', (255.0*combined_image).astype(np.uint8))
